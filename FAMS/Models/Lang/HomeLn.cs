...
namespace FADMS.Models.Lang
{
    public class HomeLn
    {
        ...
        public string prlCurrentfinacialYear { get; set; }
        public string prlCurrentfinacialYearList { get; set; }
        ...
        public string thanaInfo { get; set; }
        public string relagonInfo { get; set; }
        public string trainingOrgInfo { get; set; }
