...
namespace FADMS.Areas.FAMSDEALER.Models
{
    public class SalesInvoiceViewModel
    {
        ...
        public IEnumerable<Sp_LicenseInfoViewModel> LicensenumberLiNo { get; set; }
        public SalesReturnInvoiceMaster salesReturnInvoiceMaster { get; set; }
        public SalesInvoiceMaster salesInvoiceMaster { get; set; }
        public Sp_LicenseTypeViewModel Sp_LicenseTypeViewModels { get; set; }
        public Sp_LicenseInfoViewModel Sp_LicenseInfoViewModel { get; set; }
